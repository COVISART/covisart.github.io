...
const en = {
  ...
  fSending: 'Sending\u2026',
  accRaceSeat: 'Race seat',
  accJustSim: 'Motion base only',
  ...
  fInvalidPhone: 'Enter a valid phone number.',
  fFailedTitle: 'Request not sent',
  fFailedBody: 'We could not reach our order service. Please try again, or write to us directly.',
  fRetry: 'Try again',
...
const tr: typeof en = {
  ...
  fPhone: 'Telefon',
  fCountry: 'Ülke',
  fSize: 'Faydalı yük sınıfı',
  fAccessory: 'Kokpit',
  fUse: 'Kullanım amacı ve faydalı yük',
  fSubmit: 'Talebi gönder',
  fSending: 'Gönderiliyor\u2026',
  accRaceSeat: 'Yarış koltuğu',
  accJustSim: 'Yalnızca hareket tabanı',
  ...
  fInvalidPhone: 'Geçerli bir telefon numarası girin.',
  fFailedTitle: 'Talep gönderilemedi',
  fFailedBody: 'Sipariş servisimize ulaşılamadı. Lütfen tekrar deneyin ya da doğrudan bize yazın.',
  fRetry: 'Tekrar dene',
